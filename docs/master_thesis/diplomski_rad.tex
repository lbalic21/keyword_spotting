...
\begin{kljucnerijeci}
  obrada zvuka u stvarnom vremenu; prepoznavanje govora; Mel-frekvencijski kepstralni koeficijenti (MFCC); strojno učenje na rubnim uređajima; konvolucijske neuronske mreže (CNN); TensorFlow Lite; mikrokontroleri; ESP32 Lyrat
\end{kljucnerijeci}
...
\begin{keywords}
  real-time audio processing; speech recognition; Mel-frequency cepstral coefficients (MFCC); edge AI; convolutional neural networks (CNN); TensorFlow Lite; microcontrollers; ESP32-LyraT
\end{keywords}
